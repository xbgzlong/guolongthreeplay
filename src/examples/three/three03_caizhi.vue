...
export default {
	...
	methods: {
        ...
        setCube(){
            ...
            // 设置贴图
            const mappic = TextureLoader.load(require('../../assets/logo/logo.png'));
            ...
            let material = new THREE.MeshBasicMaterial( {color: 0xffff00,map:mappic,} ) 
            this.cube = new THREE.Mesh(this.boxGeometry,material);
            this.scene.add(this.cube);
            // 立方体
            const BoxGeometry = new THREE.BoxGeometry( 3, 3, 3, 2, 3, 4 ); 
            ...
            // 设置贴图
            const othermappic = TextureLoader.load(require('../../assets/404_images/404.png'));
            const BoxGeometrycube = new THREE.Mesh( BoxGeometry, new THREE.MeshBasicMaterial( 
                {
                    color: 0xffff00,
                    map:mappic,
            ...
            const planeMaterial = new THREE.MeshBasicMaterial( 
                {
                    ...
                    alphaMap:othermappic,
                    transparent:true,
                    // 默认是显示 FrontSide, 可以设置成 BackSide
