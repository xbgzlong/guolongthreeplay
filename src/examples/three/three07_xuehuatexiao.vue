...
export default {
	...
	methods: {
		...
		setCamera() {
			...
			this.camera = new THREE.PerspectiveCamera(75, this.container.clientWidth / this.container.clientHeight, 0.1, 7.1)
			// 设置相机位置
        ...
        setCube(){
           ...
           const TextureLoader = new THREE.TextureLoader();
            // 设置贴图
            const mappic = TextureLoader.load(require('../../assets/images/xuehua.png'));
            // 按照制作一个球形
            ...
            for(let i = 0; i<count *3;i++){
                // 给每一个数赋值为随机 -5到5的值
                positionARR[i] = Math.random()*20-10;
            ...
            this.cube2 = new THREE.Points(this.boxGeometry,material);
            this.cube3 = new THREE.Points(this.boxGeometry,material);
        ...
        setRender(time){
            ...
            this.cube2.rotation.x = time*0.0004;
            this.cube2.rotation.y = time*0.0004;
            this.cube3.rotation.x = time*0.0005;
            this.cube3.rotation.y = -time*0.0004;
